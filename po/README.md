# How to Translate storyline

## First Things First

* Clone this repository by opening the terminal in a folder of your choice and typing ```git clone https://github.com/lainsce/storyline```
...
And that's it! You've successfully translated storyline for your language!
